...
from data.incremental_data_manager import save_historical_data, load_historical_data
...
def fetch_symbol_update(exchange, symbol, filename, n_bars=7, retry_count=0):
    ...
    try:
        ...
        # Load existing data to check for new points
        ...
        # Save (incremental manager handles merging and deduplication)
